	...
	<header class="header-standard">
		...
		<nav>
			<ul class="nav-box">
				...
				<li data-menuanchor=""><a class="active">Home</a></li>
				<li data-menuanchor="about"><a>About</a></li>
				<li data-menuanchor="portfolio"><a>Portfolio</a></li>
				<li data-menuanchor="contact"><a>Contact</a></li>
			</ul>
